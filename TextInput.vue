  ...
  <div class="py-2 sm:py-3">
    <div class="sm:grid sm:grid-cols-3 sm:gap-4">
      ...
      <dd class="flex text-sm text-gray-900" :class="labelTop ? 'col-span-3' : 'col-span-2'">
        <div class="flex-grow" v-if="type === 'textarea'">
          <textarea v-model="value" :type="type" :name="field" @keyup.enter="submit(field, value)" class="block w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-sky-500 focus:border-sky-500 sm:text-sm dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600" />
        </div>
